    ...
    <Transition.Root show={props.open} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-30 overflow-y-auto" initialFocus={cancelButtonRef} onClose={() => {}}>
        <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="z-30 inline-block transform overflow-visible rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle dark:bg-teams_brand_tbody">
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              ...
                              >
                                ...
                                <option value="Afternoon dark:text-gray-200 dark:bg-teams_brand_tbody">{t('Afternoon')}</option>
                                <option value="FullDay dark:text-gray-200 dark:bg-teams_brand_tbody">{t('FullDay')}</option>
                              </select>
                            )}
                          />
                          {errors.duration && (
