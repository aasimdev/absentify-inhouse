      ...
      <Dialog as="div" className="relative z-50" initialFocus={cancelButtonRef} onClose={() => {}}>
        ...
        <div className="fixed inset-0 z-40 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 w-auto sm:p-6 dark:bg-teams_dark_mode">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex mt-1 rounded-md shadow-sm">
                      <input
                        ...
                        className="block w-60 min-w-0 grow rounded-md border-gray-300 focus:border-teams_brand_500 focus:ring-teams_brand_500 sm:text-sm dark:bg-teams_dark_mode dark:border-teams_brand_border dark:text-gray-200"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-end mt-12">
                  <button
                    ...
                    ref={cancelButtonRef}
                    className="inline-flex w-24 justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teams_brand_500 focus:ring-offset-2 dark:bg-teams_dark_mode dark:border dark:border-gray-200 dark:text-white"
                  >
                    {t('Cancel')}
                  </button>
                  <button
