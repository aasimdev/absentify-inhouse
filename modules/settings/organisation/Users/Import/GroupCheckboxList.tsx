      ...
      {groups.map((group) => (
        <div key={group.id} className="flex items-center ml-3 py-0.5">     
          <input
            type="checkbox"
            id={group.id}
            className="focus:ring-teams_brand_500 h-4 w-4 text-teams_brand_600 border-gray-300 rounded dark:bg-teams_brand_tbody dark:text-gray-200  dark:border-gray-200  dark:focus:ring-teams_brand_tbody dark:focus:bg-teams_brand_tbody"
