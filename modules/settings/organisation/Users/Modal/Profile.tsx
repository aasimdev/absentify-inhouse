      ...
      <div className=" divide-y divide-gray-200 dark:divide-gray-500">
        ...
        <div className="mt-4 flex justify-end p-4 sm:px-6">
          ...
          <button
            disabled={loading}
            type="submit"
            className="ml-5 inline-flex justify-center rounded-md border border-transparent bg-teams_brand_foreground_bg py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-teams_brand_background_2 focus:outline-none focus:ring-2 focus:ring-teams_brand_500 focus:ring-offset-2 dark:bg-teams_dark_mode_core dark:text-gray-200 dark:ring-0"
          >
