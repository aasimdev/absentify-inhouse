                ...
                <div className="lg:col-span-2 mt-6">
                  ...
                  >
                    ...
                    <div className="col-span-2 mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                      ...
                      <button
                        type="button"
                        className="mt-3 inline-flex w-full justify-center items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto dark:bg-teams_brand_tbody dark:border dark:border-gray-200 dark:text-white"
