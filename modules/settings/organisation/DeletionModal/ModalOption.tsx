...
export const ModalOption = ( props: {
  ...
  return(
    ...
    <button type="button" className=" block w-full" onClick={() => props.handleOnClick(props.text)}>
      <div className={classNames(props.active ? "bg-[#deebff] dark:bg-teams_brand_dark_400 dark:text-gray-900" : "bg-white dark:bg-teams_brand_dark_100 dark:text-gray-200",
