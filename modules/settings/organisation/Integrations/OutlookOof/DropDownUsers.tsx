              ...
              <div className="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    ...
                    <th
                        scope="col"
                        className={`min-w-20 w-32 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 lg:w-40 `}
                      >
                      <input
                            id="outOffOfficEdit"
                            ...
                            className="ml-3 h-4 w-4 rounded border-gray-300 text-teams_brand_foreground_1 focus:ring-teams_brand_450"
                          />
                      </th>
                      <th
                        scope="col"
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white ">
                    {filteredMembers.map((member) => (
                          ...
                          />
                            ...
                            <td className=" flex w-full flex-row whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-90">
                              ...
                              <img src={`https://data.absentify.com/profile-pictures/${member.microsoft_user_id}_64x64.jpeg`} alt="" className="h-8 w-8 flex-shrink-0 rounded-full" />
                                ...
                                <span
                                className={classNames('inline-block h-8 w-8 overflow-hidden rounded-full bg-gray-100')}
                              >
                              ...
                              <span className="min-w-24 ml-2 mt-2  w-32 truncate lg:w-40 cursor-pointer">
                                <span
                            ...
                            <td className="hidden w-96 whitespace-nowrap px-3 py-4 text-sm text-gray-500 md:table-cell">
                              <span className="min-w-20  mt-2 w-32 truncate lg:w-40 cursor-pointer">
                                <span
                                  data-tooltip-id="member-tooltip"
