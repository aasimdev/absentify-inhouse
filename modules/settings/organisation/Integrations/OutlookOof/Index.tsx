      ...
      <Transition.Root show={props.open} as={Fragment}>
        <Dialog as="div" className="relative z-30" initialFocus={cancelButtonRef} onClose={() => {}}>
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-gray-500 dark:bg-teams_dark_mode bg-opacity-75 transition-opacity" />
          </Transition.Child>
              ...
              {steps.map((step) => (
                <li key={step.name} className="md:flex-1">
                  {step.status === 'complete' ? (
                    ...
                    <span className="group flex flex-col border-l-4 border-gray-200 dark:border-teams_brand_border py-2 pl-4  md:border-l-0 md:border-t-4 md:pl-0 md:pt-4 md:pb-0">
                ...
                <>
                  <div className="mt-10 lg:grid lg:grid-cols-12 lg:gap-x-5">
                      ...
                      <div className="space-y-2 ">
                        ...
                        {variables.map((item) => (
                          <button
                            ...
                            type="button"
                            className="mx-1 inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teams_brand_500 focus:ring-offset-2 dark:bg-teams_dark_mode dark:border-teams_brand_border dark:text-gray-200"
                          >
                            {item.name}
                          </button>
                        ))}
                    ...
                    <div className="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
                      <div className=" w-full">
                        <div className="w-full bg-gray-50 dark:bg-teams_dark_mode  dark:text-gray-200 dark:border-teams_brand_border">
                          <ReactQuill
                            theme="snow"
                    ...
                    >
                      <div className="">
                        <input
                          ...
                          readOnly={true}
                          className="sm:mb-0 mb-4 rounded dark:text-gray-200 dark:bg-teams_dark_mode"
                        ></input>
                        <button
                          onClick={async () => {
                            if (selectedLeaveTypes.length === 0) return;
                  ...
                  <div className="relative flex items-start">
                    <div className="flex h-5 items-center">
                      <input
                        ...
                        className="h-4 w-4 rounded border-gray-300 text-teams_brand_foreground_1 focus:ring-teams_brand_450 dark:bg-teams_dark_mode  dark:text-gray-200  dark:border-gray-200  dark:focus:ring-teams_brand_tbody dark:focus:bg-teams_brand_tbody"
                      />
                    </div>
                      ...
                      <div className="relative ml-5 flex items-start">
                        <div className="flex h-5 items-center">
                          <input
                            ...
                            className="h-4 w-4 rounded border-gray-300 text-teams_brand_foreground_1 focus:ring-teams_brand_450  dark:text-gray-200 dark:bg-teams_dark_mode  dark:border-gray-200  dark:focus:ring-teams_brand_tbody dark:focus:bg-teams_brand_tbody"
                          />
                        </div>
                        <div className="ml-3 text-sm">
                          ...
                          <div className="space-y-2 ">
                            ...
                            {variables.map((item) => (
                              <button
                                ...
                                type="button"
                                className="mx-1 inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teams_brand_500 focus:ring-offset-2  dark:border-teams_brand_border dark:bg-dark:border-teams_brand_border  dark:text-gray-200"
                              >
                                {item.name}
                              </button>
                            ))}
                        ...
                        >
                          <div className="">
                            <input
                              ...
                              value={current_member?.email + ''}
                              readOnly={true}
                              className="sm:mb-0 mb-4 dark:bg-teams_dark_mode  dark:text-gray-200"
                            ></input>
                            <button
                              onClick={async () => {
                                if (selectedLeaveTypes.length === 0) return;
