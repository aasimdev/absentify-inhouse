        ...
        <>
          <div className="relative mt-2">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm dark:bg-teams_dark_mode  dark:text-gray-200">
                {members.map((member) => (
                  <Listbox.Option
                    key={member.id}
                    className={({ active }) =>
