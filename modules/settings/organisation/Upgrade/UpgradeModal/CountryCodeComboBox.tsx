  ...
  return (
    <Combobox as="div" value={selectedCountry || value} onChange={setSelectedCountry}>
      <div className="relative mt-2">
        <Combobox.Input
          className={`w-full rounded-md bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 focus:ring-teams_brand_500 ${error ? 'border border-red-500' : 'border-0'}`}
