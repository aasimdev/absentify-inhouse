        ...
        <div className="px-4 sm:px-6">
          <div className="inline-block w-full max-w-lg transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom transition-all sm:my-8 sm:p-6 sm:align-middle dark:bg-teams_brand_tbody">
            <div className="sm:flex sm:items-start">
              <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10 dark:bg-teams_dark_mode">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 dark:text-teams_brand_gray">{t('Delete_company_account_description1')}</p>
                  <p className="font-bold text-red-600 dark:text-teams_brand_gray">{t('Delete_company_account_description2')}</p>
                </div>
              </div>
            </div>
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                ...
                disabled={loading}
                type="button"
                className="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm dark:bg-teams_brand_dark_300 dark:ring-teams_brand_tbody_border dark:text-teams_brand_gray"
              >
                {loading && (
