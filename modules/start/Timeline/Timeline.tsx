...
const Timeline: NextPage = () => {
  ...
  return (
    <>
      <div className="flex min-h-96 grow flex-col border-y bg-white dark:bg-black shadow sm:rounded sm:border dark:sm:border-black">
        ...
        <div className="-mb-px flex  h-[50vh]  justify-end py-2 pl-0 pr-2 lg:h-[70vh] lg:pr-2 lg:pl-1   ">
          <div
            ref={containerRef}
            className={'flex h-auto w-full flex-col overflow-y-auto overflow-x-hidden bg-white dark:bg-black text-sm '}
          >
            <div className={` sticky top-0 z-[15] inline-flex w-auto justify-end bg-white text-sm dark:bg-black`}>
              {days.map((d, index) => {
                if (showCW) {
